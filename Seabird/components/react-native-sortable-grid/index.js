...
class SortableGrid extends Component {
  ...
  setViewIsScrolling = (bool) => {
    this.setState({ viewIsScrolling: bool });
    console.log('the view is scrolling:');
    console.log(this.state.viewIsScrolling);
  }
