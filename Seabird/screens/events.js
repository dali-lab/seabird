...
export default class Events extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      dataSource: ds.cloneWithRows([ new EventItem(), 'row 2', 'row 3', 'row 4', 'row 1', 'row 2', 'row 3', 'row 4', 'row 1', 'row 2', 'row 3', 'row 4', 'row 1', 'row 2', 'row 3', 'row 4', 'row 1', 'row 2', 'row 3', 'row 4', 'row 1', 'row 2', 'row 3', 'row 4', 'row 1', 'row 2', 'row 3', 'row 4', 'row 1', 'row 2', 'row 3', 'row 4']),
    };
  }
